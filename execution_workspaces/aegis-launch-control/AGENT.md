# Coding Agent — Aegis Launch Control

## Project Identity
- **Project**: Aegis Launch Control
- **Project ID**: `aegis-launch-control`
- **Workspace**: `execution_workspaces/aegis-launch-control/`
- **Repo root**: `execution_workspaces/aegis-launch-control/repo/`
...
- Project-level memory (`PROJECT.md`, `STATUS.md`, `TASK_QUEUE.md`,
  `DECISIONS.md`, `RESEARCH.md`) lives in `projects/aegis-launch-control/` and is
...
- Stay inside `execution_workspaces/aegis-launch-control/`. Do not touch other
